--[[
    ...
    pattern using `:param` segments, and a handler. This is what lets
    /api/v1/me/gamemodes/:gameModeId/statistics stay a single generic route
    instead of one hardcoded route per GameMode.
]]
...
--- Register a route. pattern example: "/api/v1/me/gamemodes/:gameModeId/history"
