--[[
    ...
    for gamemode/admin request signing) using only stdlib + FiveM natives.
...
--- Simple keyed hash (HMAC-ish construction) for signing internal/admin and
-- gamemode <-> server-api requests. Same caveat as above: adequate for
-- trusted-server-to-server signing, not a general-purpose HMAC-SHA256.
