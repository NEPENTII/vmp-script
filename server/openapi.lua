--[[
    ...
    every fixed route in server/api.lua. GameMode-specific contracts are
    NOT here -- those stay in docs/gamemodes/<id>.md via docs-generator.lua,
    since they're dynamic and per-GameMode.
...
function OpenApi.Generate()
    return {
        ...
        paths = {
            ...
            ['/api/v1/me/status'] = { get = op('Online status + current GameMode', { tags = { 'me' }, auth = 'bearer' }) },
            ...
            ['/api/v1/me/statistics'] = { get = op('Statistics across every GameMode', { tags = { 'me' }, auth = 'bearer' }) },
            ['/api/v1/me/activity'] = { get = op('Recent activity feed', { tags = { 'me' }, auth = 'bearer', parameters = PAGINATION_PARAMS }) },
            ['/api/v1/gamemodes'] = { get = op('Public list of registered GameModes', { tags = { 'gamemodes' } }) },
            ['/api/v1/me/gamemodes'] = { get = op('GameModes + this player\'s stats', { tags = { 'gamemodes' }, auth = 'bearer' }) },
            ['/api/v1/me/gamemodes/{gameModeId}'] = { get = op('One GameMode + this player\'s stats', { tags = { 'gamemodes' }, auth = 'bearer' }) },
            ['/api/v1/me/gamemodes/{gameModeId}/statistics'] = { get = op('This player\'s stats for one GameMode', { tags = { 'gamemodes' }, auth = 'bearer' }) },
            ['/api/v1/me/gamemodes/{gameModeId}/history'] = { get = op('History entries', { tags = { 'gamemodes' }, auth = 'bearer', parameters = PAGINATION_PARAMS }) },
            ['/api/v1/me/gamemodes/{gameModeId}/activity'] = { get = op('GameMode-scoped activity', { tags = { 'gamemodes' }, auth = 'bearer', parameters = PAGINATION_PARAMS }) },
